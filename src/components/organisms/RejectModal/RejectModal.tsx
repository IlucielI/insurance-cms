...
export const RejectModal: React.FC<RejectModalProps> = ({
  ...
  return (
    <Modal
      ...
      subtitle={`Aplikasi ${applicationId.startsWith('#') ? applicationId : `#${applicationId}`} • Pemohon: ${applicantName} • Tindakan ini bersifat final dan mencatat alasan aktuarial resmi sesuai regulasi OJK & AAJI.`}
      footer={
