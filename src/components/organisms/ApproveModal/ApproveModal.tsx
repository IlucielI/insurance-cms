...
export const ApproveModal: React.FC<ApproveModalProps> = ({
  ...
  return (
    <Modal
      ...
      subtitle={`Aplikasi ${applicationId.startsWith('#') ? applicationId : `#${applicationId}`} • Produk: ${productName} • Tertanggung: ${applicantName} (${applicantEmail}) • Polis aktif akan diterbitkan resmi.`}
      footer={
