  ...
  private dossiers: UnderwritingDossier[] = [
    {
      ...
      reviewChecks: [
        ...
        },
        {
          ...
          statusColor: '#065f46',
          details:
            'Dokumen terunggah: Foto KTP Asli (OK), Foto Selfie Liveness (OK), NPWP (OK), Bukti Penghasilan (OK). Semua 4 dokumen memenuhi standar resolusi dan lulus uji metadata EXIF.',
    ...
    },
    {
      ...
      totalChecksCount: 4,
      internalAuditNotes:
        'Semua berkas dan hasil otomatis telah lolos. Menunggu keputusan akhir underwriter.',
      auditSignature:
        'Diperiksa oleh: Bayu Pratama (NIP: UW-2026-042) • Terhubung ke PATCH /api/v1/applications/:id/status',
      auditHash:
      ...
      reviewChecks: [
        {
          ...
          statusBg: '#d1fae5',
          statusColor: '#065f46',
          details: 'Dukcapil match 100%. Liveness Biometric cocok.',
          reviewer: 'System OCR Worker (Auto)',
        },
        {
          type: 'income_verified',
          title: '2. Verifikasi Pendapatan & Debt-to-Income (DSR)',
          ...
          statusBg: '#d1fae5',
          statusColor: '#065f46',
          details: 'Gaji Pokok: IDR 12.000.000/bln. Rasio Premi: 1.8% (Aman).',
          reviewer: 'System DSR Calculator (Auto)',
        },
        {
          type: 'documents_complete',
          title: '3. Kelengkapan Berkas & Legalitas',
          ...
          statusBg: '#d1fae5',
          statusColor: '#065f46',
          details: 'Semua berkas identitas dan pernyataan kesehatan lengkap.',
          reviewer: 'System Doc Validator',
        },
        {
          type: 'medical_required',
          title: '4. Skrining Medis & Risk Threshold',
          ...
          statusBg: '#f1f5f9',
          statusColor: '#64748b',
          details: 'Tanpa tes lab. Risiko di bawah batas ambang.',
          reviewer: 'Auto-Rule Engine (Waived)',
        },
      ],
    },
    {
      id: '#APP-2026-8825',
      applicantName: 'Agus Kurniawan',
      applicantAge: 38,
      nik: '3175058809860007',
      productName: 'Secure Life Plus',
      productSlug: 'secure-life-plus',
      sumAssured: 'Rp 500.000.000',
      status: 'approved',
      ...
      autoDebet: true,
      beneficiaryName: 'Dewi Lestari (Istri)',
      beneficiaryRelation: 'Istri',
      beneficiarySharePct: 100,
      passedChecksCount: 4,
      totalChecksCount: 4,
      internalAuditNotes:
        'Polis telah disetujui dan diterbitkan secara otomatis dengan nomor POL-2026-8825.',
      auditSignature:
        'Diperiksa oleh: Auto-Underwriting System • Approved on 2026-09-06 08:30 WIB',
      auditHash:
        'sha256:5e67c1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9075',
      reviewChecks: [
        {
          type: 'identity_verified',
          title: '1. Verifikasi Identitas (Dukcapil OCR)',
